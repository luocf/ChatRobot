...
extern "C" {
    ...
    Java_com_qcode_chatrobot_common_CarrierProxy_getAddress(
            JNIEnv *env,
            jobject /* this */) {
        std::string address;
    ...
    JNIEXPORT jstring JNICALL
    Java_com_qcode_chatrobot_common_CarrierProxy_getUserId(
            JNIEnv *env,
            jobject /* this */) {
        std::string user_id;
    ...
    Java_com_qcode_chatrobot_common_CarrierProxy_startChatRobot(
            JNIEnv *env,
            jobject /* this */,
            jstring jdata_dir) {
    ...
    JNIEXPORT jint JNICALL
    Java_com_qcode_chatrobot_common_CarrierProxy_runChatRobot(
            JNIEnv *env,
            jobject /* this */) {
    ...
    Java_com_qcode_chatrobot_common_CarrierProxy_getMemberList(JNIEnv *env, jobject jobj) {
