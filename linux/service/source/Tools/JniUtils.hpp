...
//    static std::shared_ptr<_jobject> GetObjectSafely(JNIEnv* env, int64_t value);
    ...
    static std::shared_ptr<_jobject> GetLocalObjectRefSafely(JNIEnv* env, jobject value);


    static std::shared_ptr<const char> GetStringSafely(JNIEnv* env, jstring str);
    static std::shared_ptr<_jstring> GetStringSafely(JNIEnv* env, const char* str);
    ...
    static jclass GetJavaClass(const char* class_name);
...
//    static const char* JavaClassNameLong;
    ...
    static const char* JavaClassNameObjectArray;
    static const char* JavaClassNameObject;

    static constexpr const char *TAG = "RobotJni";
